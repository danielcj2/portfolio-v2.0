...
const BentoBox = () => {
  return (
    <motion.div
      className="mx relative grid h-335 auto-rows-fr grid-cols-9 gap-4 px-2 py-6 xl:h-235 xl:grid-cols-10 2xl:grid-cols-12"
      initial="initial"
      whileHover="hovered"
      variants={{ initial: { opacity: 0.7 }, hovered: { opacity: 1 } }}
      transition={{ duration: 0.6 }}
    >
      <motion.div
        className="bg-background pointer-events-none absolute inset-0 z-1 mix-blend-color"
