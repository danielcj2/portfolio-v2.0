  ...
  return (
    ...
    >
      <motion.div {...props}>
        ...
        >
          <div className="transition-scale duration-300 ease-in-out group-hover:scale-65">
            <Asterisk className="[&_path]:group-hover:fill-foreground h-14 w-auto [&_path]:transition-colors [&_path]:duration-300" />
          </div>
        </motion.div>
        <motion.svg
